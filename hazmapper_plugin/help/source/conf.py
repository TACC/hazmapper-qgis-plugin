...
project = u'HazmapperPlugin'
copyright = u'2013, DesignSafe-CI'
...
latex_documents = [
  ('index', 'HazmapperPlugin.tex', u'HazmapperPlugin Documentation',
   u'DesignSafe-CI', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'HazmapperPlugin Documentation',
     [u'DesignSafe-CI'], 1)
]
